...
public class TimerFragment extends DeskClockFragment implements OnSharedPreferenceChangeListener {
                ...
                if (t.mState == TimerObj.STATE_RUNNING || t.mState == TimerObj.STATE_TIMESUP) {
                    ...
                    if (t.mView != null) {
                        ...
                        if (toggle) {
                            ...
                            addMinuteButton.setBackgroundResource(R.color.transparent);
    ...
    public void setLeftRightButtonAppearance() {
        ...
        mLeftButton.setBackgroundResource(R.color.transparent);
        ...
        mRightButton.setBackgroundResource(R.color.transparent);
