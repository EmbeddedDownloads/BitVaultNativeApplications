...
import static net.sourceforge.opencamera.MainActivity.viewS;
...
private void setPreviewFps() {
	...
	public void takePicturePressed() {
		...
		//MainActivity.viewS.setVisibility(View.VISIBLE);
	}
...
public void hideSettingIcon(){
	if(!this.isVideo()){
		MainActivity.viewS.setVisibility(View.GONE);
	}
}
	@TargetApi(Build.VERSION_CODES.LOLLIPOP)
